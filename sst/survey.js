...
const upps_items = jsPsych.randomization.repeat(
  [
    ...
    {
      text: '気分が悪い時には，ときどき，たとえ気分をさらに悪くするようなことであっても，私はその時にしていることがやめら れない気がする',
    ...
    { text: 'とても機嫌が良い時には，私は自制心を失う傾向がある', value: 'UPPS_posUrgency_20' },
...
const abis_items = jsPsych.randomization.repeat(
  [
    {text: '私は，何も考えずに物事を進める', value: 'ABIS_motor_1'},
    {text: '私は，考えなしにものを言う', value: 'ABIS_motor_2'},
    {text: '私は，まったく『衝動的』に行動する', value: 'ABIS_motor_3'},
    {text: '私は，突然の衝動にかられて行動する', value: 'ABIS_motor_4'},
    {text: '私は，仕事の計画を入念に立てる', value: 'ABIS_nonPlan_5'},
    {text: '私は，前もって，十分に練った旅行計画を立てる', value: 'ABIS_nonPlan_6'},
    {text: '私は，雇用の安定のために画策する', value: 'ABIS_nonPlan_7'},
    {text: '私は，未来志向である', value: 'ABIS_nonPlan_8'},
    {text: '私は，『細部まで気を配る』ことがない', value: 'ABIS_attention_9'},
    {text: '私は，自制心がある', value: 'ABIS_attention_10'},
    {text: '私にとって，集中することは容易である', value: 'ABIS_attention_11'},
    {text: '私は，じっくりと考える', value: 'ABIS_attention_12'},
    {text: '私は，常に考え方が安定している', value: 'ABIS_attention_13'},
  ],
  1
);
